  ...
  var render2 = function(st) {
    ...
    var tile = function(i2) {
      return function(r) {
        ...
        return div2([class_("ws-tile" + ((function() {
          ...
          var $134 = eq12(st.playing)(new Just(i2));
          if ($134) {
            return " is-playing";
          }
          ;
          ...
          return new Play(i2);
        })])([svg(maybe([])(function($299) {
          return cut2((function(v) {
            return v.lo;
          })($299));
        })(st.peaks))(maybe([])(function($300) {
          return cut2((function(v) {
            return v.hi;
          })($300));
      ...
      if (otherwise) {
        return div2([class_("ws-send")])([span3([class_("ws-arm-label")])([text5("Send to")]), small2("bank")(st.bank)(SetBank.create), small2("kit")((function() {
          ...
          return option([value13(show12(n)), selected2(n === st.voice)])([text5(show12(n) + (function() {
            var $144 = notEq1(foldsTo(st.kind))(ToMono.value);
            if ($144) {
              return " + " + show12(n + 1 | 0);
            }
            ;
          ...
          ;
          throw new Error("Failed pattern match at Workshop.Main (line 685, column 26 - line 687, column 71): " + [occupant.constructor.name]);
        })())]), (function() {
          if (occupant instanceof Nothing) {
            return text5("");
          }
          ...
          ;
          throw new Error("Failed pattern match at Workshop.Main (line 697, column 13 - line 702, column 89): " + [occupant.constructor.name]);
        })()]);
      }
      ;
      throw new Error("Failed pattern match at Workshop.Main (line 662, column 3 - line 703, column 12): ");
    })();
    var lp = loop2(st);
    ...
    var kindBtn = function(k) {
      return button([class_("ws-kind" + (function() {
        var $150 = name15(k) === name15(st.kind);
        if ($150) {
          return " on";
        }
        ;
    ...
    var dividerRow = (function() {
      ...
      ;
      throw new Error("Failed pattern match at Workshop.Main (line 632, column 3 - line 650, column 12): ");
    })();
    var connection = (function() {
      ...
      ;
      throw new Error("Failed pattern match at Workshop.Main (line 480, column 16 - line 482, column 80): " + [st.looper.constructor.name]);
    })();
    var chip = function(n) {
      return function(s) {
        return button([class_("ws-chip is-arm" + ((function() {
          var $157 = srcNow === (n + 1 | 0);
          if ($157) {
            return " on";
          }
          ;
    ...
    var caught = (function() {
      ...
      if (otherwise) {
        return section([class_("ws-caught")])([h2_([text5("What was caught")]), (function() {
          ...
          var $164 = $$null2(st.regions) && (hasTake && !st.busy);
          if ($164) {
      ...
      ;
      throw new Error("Failed pattern match at Workshop.Main (line 572, column 3 - line 624, column 12): ");
    })();
    var cardView = section([class_("ws-card")])([h2_([text5("The card, so far")]), (function() {
      ...
      if (st.cardView instanceof Just) {
        ...
        if (otherwise) {
          return div_([table([class_("ws-table")])([thead_([tr_(map23(function(h) {
            ...
            var $166 = st.cardView.value0.plan === "";
            if ($166) {
              return text5("");
            }
            ;
      ...
      ;
      throw new Error("Failed pattern match at Workshop.Main (line 771, column 9 - line 790, column 20): " + [st.cardView.constructor.name]);
    })()]);
    ...
    var recordBox = section([class_("ws-rec")])([h2_([text5("Record")]), div2([class_("ws-kinds")])(map23(kindBtn)(all3)), (function() {
      ...
      var $171 = eq4(foldsTo(st.kind))(ToMono.value);
      if ($171) {
        return "mono";
      }
      ;
      ...
      var $173 = st.armed || (writing || listening);
      if ($173) {
            ...
            return bind6(liftAff2(attempt(toAffE(divisions({
              ...
              if (r instanceof Left) {
                return modify_3((function() {
                  var $301 = note("could not analyse: " + message(r.value0));
                  return function($302) {
              ...
              if (r instanceof Right) {
                if (!r.value0.ok) {
                  return modify_3((function() {
                    var $303 = note(r.value0.output);
                    return function($304) {
                      return $303((function(v) {
                        return {
                          looper: v.looper,
                          kind: v.kind,
                          bars: v.bars,
                ...
                if (otherwise) {
                  ...
                  return discard12(modify_3(function(v) {
                    ...
                    ;
                    $184.regions = r.value0.regions;
                    $184.keep = fromFoldable4(range2(0)(n - 1 | 0));
                    $184.busy = false;
                    $184.showing = takeName;
                    return $184;
                  }))(function() {
              ...
              ;
              throw new Error("Failed pattern match at Workshop.Main (line 408, column 7 - line 423, column 80): " + [r.constructor.name]);
            });
          });
        });
      };
    ...
    return function(v) {
                    ...
                    return bind6(get2)(function(st) {
                      return discard12(for_3(loop2(st))(function(lp) {
                        return when4(st.armed && (!lp.armed && (not1(isWriting)(lp) && lp.layers > 0)))(modify_3((function() {
                          var $305 = note("closed itself: " + (fmt(lp.loopSecs) + " s"));
                          return function($306) {
      ...
      if (v instanceof PickKind) {
        return discard12(modify_3(function(v1) {
          ...
          ;
          $202.kind = v.value0;
          $202.divider = defaultFor(v.value0);
          return $202;
        }))(function() {
          return bind6(get2)(function(st) {
        ...
        return bind6(liftAff2(attempt(toAffE(card))))(function(r) {
          ...
          if (r instanceof Right) {
            return modify_3(function(v2) {
              ...
              ;
              $221.cardView = new Just(r.value0);
              return $221;
            });
          }
          ;
      ...
      if (v instanceof SetVoice) {
        return modify_3(function(s) {
          ...
          ;
          $233.voice = clamp3(1)(4)(fromMaybe(s.voice)(fromString2(v.value0)));
          return $233;
        });
      }
      ;
        ...
        return discard12(modify_3(function(v1) {
          ...
          return bind6(liftAff2(attempt(toAffE(writeToCard(v.value0)))))(function(r) {
            return discard12((function() {
              if (r instanceof Left) {
                return modify_3((function() {
                  var $307 = note(message(r.value0));
                  return function($308) {
                    return $307((function(v1) {
                      return {
                        looper: v1.looper,
                        kind: v1.kind,
                        bars: v1.bars,
              ...
              if (r instanceof Right) {
                return modify_3((function() {
                  var $309 = note(lastLine(r.value0.output));
                  return function($310) {
                    return $309((function(v1) {
                      return {
                        looper: v1.looper,
                        kind: v1.kind,
                        bars: v1.bars,
          ...
          return discard12(modify_3(function(v1) {
            ...
            return bind6(liftAff2(attempt(toAffE(addToCard({
              ...
              return discard12((function() {
                if (r instanceof Left) {
                  return modify_3((function() {
                    var $311 = note(message(r.value0));
                    return function($312) {
                      return $311((function(v1) {
                        return {
                          looper: v1.looper,
                          kind: v1.kind,
                          bars: v1.bars,
                ...
                if (r instanceof Right) {
                  return modify_3((function() {
                    var $313 = note(lastLine(r.value0.output));
                    return function($314) {
                      return $313((function(v1) {
                        return {
                          looper: v1.looper,
                          kind: v1.kind,
                          bars: v1.bars,
                ...
                ;
                throw new Error("Failed pattern match at Workshop.Main (line 283, column 9 - line 285, column 85): " + [r.constructor.name]);
              })())(function() {
                return handleAction(dictMonadAff)(RefreshCard.value);
              });
            });
      ...
      if (v instanceof SetGap) {
        return discard12(modify_3(function(s) {
          var $254 = {};
          for (var $255 in s) {
            if ({}.hasOwnProperty.call(s, $255)) {
              $254[$255] = s[$255];
            }
            ;
          }
          ;
          $254.minGap = fromMaybe(s.minGap)(fromString(v.value0));
          return $254;
        }))(function() {
          return bind6(get2)(function(st) {
      ...
      if (v instanceof ToggleKeep) {
        return modify_3(function(s) {
          ...
          ;
          $278.keep = (function() {
            var $277 = member3(v.value0)(s.keep);
            if ($277) {
                ...
                return discard12(send1(new Sounding(false)))(function() {
                  return discard12(send1(new OnGrid(false)))(function() {
                    return discard12((function() {
                      ...
                      ;
                      throw new Error("Failed pattern match at Workshop.Main (line 350, column 5 - line 352, column 26): " + [v1.constructor.name]);
                    })())(function() {
                      return discard12(send1(new LevelArm(true)))(function() {
                        return discard12(send1(Record.value))(function() {
                          return discard12(when4(wantsAName(st))(bind6(liftEffect12(slugFor(st.kind)))(function(n) {
                            ...
                            return modify_3((function() {
                              var $315 = note(prompt(st.kind));
                              return function($316) {
                                return $315((function(v1) {
                                  return {
                                    looper: v1.looper,
                                    kind: v1.kind,
                                    bars: v1.bars,
      ...
      ;
      throw new Error("Failed pattern match at Workshop.Main (line 184, column 16 - line 377, column 56): " + [v.constructor.name]);
    };
  };
